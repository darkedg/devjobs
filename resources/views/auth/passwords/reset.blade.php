            ...
            <div class="flex flex-col break-words bg-white border border-2 shadow-md mt-20">
                ...
                <form class="py-10 px-5" method="POST" action="{{ route('password.update') }}" novalidate>
                    ...
                    <div class="flex flex-wrap mb-6">
                        ...
                        <input id="email" type="email" class="p-3 bg-gray-200 rounded form-input w-full @error('email') border border-red-500 @enderror" name="email" value="{{ $email ?? old('email') }}" autocomplete="email" autofocus>
                    ...
                    <div class="flex flex-wrap">
                        <button type="submit" class="bg-teal-500 w-full hover:bg-teal-700 text-gray-100 p-3 focus:shadow-outline uppercase font-bold">
                            {{ __('Reset Password') }}
                        </button>
                    </div>
                </form>
